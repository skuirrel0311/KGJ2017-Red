...
public class BaseCharacterController2D : MonoBehaviour
{
    ...
    {
        hp = maxHp;
        underCollider[0] = transform.Find("UnderCollider/UnderCollider_B").GetComponent<Transform>();
        underCollider[1] = transform.Find("UnderCollider/UnderCollider_C").GetComponent<Transform>();
        underCollider[2] = transform.Find("UnderCollider/UnderCollider_F").GetComponent<Transform>();
